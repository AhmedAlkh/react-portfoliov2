      ...
      <main className="center">
        <div>
          <p>
            ...
            front-end developer who enjoys building websites and applications. I
            started coding in 2021 and graduated from an accelerated web
            development course at University of Toronto(SCS) in 2022. Since
            then, I have been coding independently and improving my skills. Some
